...
public class ArticleDetailActivity extends ShearLockBaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		home_btn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i = new Intent(ArticleDetailActivity.this,TabsFragmentActivity.class);
				startActivity(i);
			}
		});
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////
		...
		right.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				currentImageNo++;
				if(currentImageNo > TabsFragmentActivity.articleListArray.size()-1 ){
					
				
						currentImageNo=TabsFragmentActivity.articleListArray.size()-1;
		...
		pager.setAdapter(new ImagePagerAdapter(TabsFragmentActivity.articleListArray));
		pager.setCurrentItem(currentImageNo);
		...
		pager.setOnPageChangeListener(new OnPageChangeListener() {
			...
			if(arg0 >= 0 && arg0 < TabsFragmentActivity.articleListArray.size()){
					currentImageNo =arg0;
					if(currentImageNo<= 0){
						left.setEnabled(false);
					}else{
...
//    }
    ...
    private class ImagePagerAdapter extends PagerAdapter {
		...
		public Object instantiateItem(View view, int position) {
			...
			activityname.setText("Articles");
			title.setText(TabsFragmentActivity.articleListArray.get(position).getArticle_title());
			createDate.setText("Start " +TabsFragmentActivity.articleListArray.get(position).getCreated());
			endDate.setText("End "+ TabsFragmentActivity.articleListArray.get(position).getEnddate());
			text.setText(TabsFragmentActivity.articleListArray.get(position).getArticle_teaser());

			String imageUrl = TabsFragmentActivity.articleListArray.get(position).getImage_url();
			imageLoader2.displayImage(imageUrl, imageView, options, new SimpleImageLoadingListener() {
				...
				public void onLoadingComplete(Bitmap loadedImage) {
					...
					Bitmap bmp = Bitmap.createScaledBitmap(loadedImage,480, 400, false);
